...
public class UserService implements BaseService {
  ...
  public ResponseEntity<?> loginUser(String emailAddress, String password) {
    return userRepositoryService.loginUser(emailAddress, password);

  }
  public ResponseEntity<?>  getUserByEmail(String email) {
    // Implement the logic to fetch the user by email from the database
    return userRepositoryService.findByEmailAddress(email);
  }
