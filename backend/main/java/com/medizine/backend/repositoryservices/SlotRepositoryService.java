...
public class SlotRepositoryService {
  ...
  private static final TimeZone INDIAN_TIME_ZONE = TimeZone.getTimeZone("Asia/Kolkata");
  ...
  private static LocalTime getLocalTimeFromDate(Date date) {
    ...
    calendar.setTimeZone(INDIAN_TIME_ZONE);
  ...
  public ResponseEntity<?> createSlot(Slot slot){
    ...
    if (isSlotOverlap(timeSlots, slot)) {
      ...
      return ResponseEntity.ok().body("Slot Created Successfully");
    }
  }
  ...
  public Slot deleteSlotById(String slotId) {
    ...
    public List<Slot> getSlotsByDoctorIdAndDate(String doctorId, Date date) {
        LocalDate localDate = getLocalDate(date);
        return slotRepository.getAllByDoctorIdAndDate(doctorId,localDate );
    }
