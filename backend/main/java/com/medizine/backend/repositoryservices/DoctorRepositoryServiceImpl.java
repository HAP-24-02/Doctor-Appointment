...
public class DoctorRepositoryServiceImpl implements DoctorRepositoryService {
  ...
  @Override
  public ResponseEntity<String> login(String emailAddress, String password) {
    Doctor doctor = doctorRepository.findByEmailAddress(emailAddress);
    ...
    // Additional validation code, if needed
  ...
  public ResponseEntity<?> findByEmailAddress(String emailAddress) {
    Doctor user = doctorRepository.findByEmailAddress(emailAddress);
